class SearchBar extends HTMLElement {
    ...
    render() {
        ...
        <div>
            ...
            <input id="searchElement" class="p-2 text-white w-36 hover:bg-sky-900 ease-in transition-all bg-slate-400/20 lg:ml-4 rounded-md shadow-sm" type="text" name="search" placeholder="Search">
            </form>
        </div>
