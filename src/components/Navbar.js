        ...
        <nav>
            <ul class="flex flex-row border-b border-slate-900/10 backdrop-blur-sm lg:px-8 lg:border-1 justify-between p-4 shadow">
                ...
                <div class="flex text-white lg:text-lg text-base cursor-pointer flex-row gap-2 lg:mr-6">
                    <li class="p-2 hover:bg-slate-400/20 rounded-md hover:text-sky-400"><a target="blank" href='https://www.dicoding.com/'>Home</a></li>
                    <li class="p-2 hover:bg-slate-400/20 rounded-md hover:text-sky-400"><a target="blank" href='https://github.com/fahminbl'>About</a></li>
                    <li class="p-2 hover:bg-slate-400/20 rounded-md hover:text-sky-400"><a target="blank" href='https://instagram.com/fahmi.foreach_a2r.true'>Contact</a></li>
                </div>
            </ul>
        </nav>
    `
